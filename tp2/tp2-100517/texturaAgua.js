...
class TexturaAgua {
	...
	draw() {
		...
		gl.uniform1i(shaderProgramAgua.samplerUniform0, 1);
		
        gl.activeTexture(gl.TEXTURE2);
		gl.bindTexture(gl.TEXTURE_2D, this.textures[1]);
		gl.uniform1i(shaderProgramAgua.samplerUniform1, 2);

		gl.activeTexture(gl.TEXTURE3);
		gl.bindTexture(gl.TEXTURE_2D, this.textures[2]);
		gl.uniform1i(shaderProgramAgua.samplerUniform2, 3);
		
		gl.uniform1f(gl.getUniformLocation(shaderProgramAgua, "scale1"), this.scale1);
		//gl.uniform1f(gl.getUniformLocation(shaderProgramAgua, "low"), this.low);
		//gl.uniform1f(gl.getUniformLocation(shaderProgramAgua, "high"), this.high);
