class ColaHelicoptero {
    ...
    constructor(helicoptero, posicion, rotacion) {
        ...
        var puntosRecorrido = [[0,0.48,0], [0,3.2,3.2], [0, 3.2, 1,0], [0,3.0,8.0]];
        ...
        var superficie = new TuboSenoidal(0, 1, 0.02, 0.75); // amplitud_onda, longitud_onda, radio, altura
        ...
        this.objeto.setEscala(1.0, 1.0, 1.0);
